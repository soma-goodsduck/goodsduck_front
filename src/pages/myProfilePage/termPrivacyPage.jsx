...
const TermPrivacyPage = (props) => {
  return (
    <>
      <HeaderInfo text="개인정보 처리방침" />
      <div style={{ padding: "60px 15px" }}>
        <p className={styles.termTitle}>제1조 (목적)</p>
        <p className={styles.termBody}>
          굿즈덕(이하 &apos;회사&apos;라고 함)는 회사가 제공하고자 하는
          서비스(이하 ‘서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의
          정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망
          이용촉진 및 정보보호 등에 관한 법률(이하 &apos;정보통신망법&apos;) 등
          관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을
          신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이
          개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
        </p>

        <p className={styles.termTitle}>제2조 (개인정보 처리의 원칙)</p>
        <p className={styles.termBody}>
        ...
        <p className={styles.termTitle}>제3조 (본 방침의 공개)</p>
        <div className={styles.termLists}>
          <ol type="1">
            ...
            <li className={styles.term}>
              ...
              <ol type="A">
                <li className={styles.term}>
                  회사가 운영하는 웹사이트의 별도의 창을 통하여 공지하는 방법
                </li>
                <li className={styles.term}>
        ...
        <p className={styles.termTitle}>제4조 (회원 가입을 위한 정보)</p>
        <div className={styles.termLists}>
          <ol type="1">
            <li className={styles.term}>
              필수 수집 정보: 휴대폰 번호, 이메일 주소, 닉네임, 좋아하는 아이돌
            </li>
          </ol>
        </div>

        <p className={styles.termTitle}>제5조 (본인 인증을 위한 정보)</p>
        <div className={styles.termBody}>
          회사는 이용자의 본인인증을 위하여 다음과 같은 번호 정보를 수집합니다.
          <ol type="1" className={styles.termLists}>
            <li className={styles.term}>필수 수집 정보: 휴대폰 번호</li>
          </ol>
        </div>

        <p className={styles.termTitle}>제6조 (회사 서비스 제공을 위한 정보)</p>
        <div className={styles.termBody}>
        ...
        <div className={styles.termBody}>
          회사는 이용자의 서비스 이용 및 부정이용의 확인 및 분석을 위하여 다음과
          같은 정보를 수집합니다
          <ol type="1" className={styles.termLists}>
            <li className={styles.term}>
          ...
          ※ 부정이용 : 거래파기, 욕설 등을 반복적으로 행하거나 회사가 제공하는
          이벤트 혜택 등의 경제상 이익을 불·편법적으로 수취하는 행위, 이용약관
          등에서 금지하고 있는 행위, 명의도용 등의 불·편법행위 등을 말합니다.
          수집되는 정보는 회사 서비스 이용에 따른 통계∙분석에 이용될 수
          있습니다.
        </div>

        <p className={styles.termTitle}>제8조 (개인정보 수집 방법)</p>
        <div className={styles.termBody}>
        ...
        <p className={styles.termTitle}>제9조 (개인정보 이용)</p>
        <div className={styles.termBody}>
          ...
          <ol type="1" className={styles.termLists}>
            ...
            <li className={styles.term}>회사의 서비스를 제공하기 위한 경우</li>
            <li className={styles.term}>신규 서비스 개발을 위한 경우</li>
            <li className={styles.term}>
        ...
        <p className={styles.termTitle}>제11조 (개인정보의 보유 및 이용기간)</p>
        <div className={styles.termBody}>
          <ol type="1" className={styles.termLists}>
            <li className={styles.term}>
          ...
          <ol type="1" className={styles.termLists}>
            <li className={styles.term}>
              ...
              <ol type="A" className={styles.termLists}>
                ...
                <li className={styles.term}>표시•광고에 관한 기록 : 6개월</li>
              </ol>
            </li>
            <li className={styles.term}>
              통신비밀보호법에 따른 보유정보 및 보유기간
              <ol type="A" className={styles.termLists}>
                <li className={styles.term}>웹사이트 로그 기록 자료 : 3개월</li>
              </ol>
            </li>
            <li className={styles.term}>
              전자금융거래법에 따른 보유정보 및 보유기간
              <ol type="A" className={styles.termLists}>
                <li className={styles.term}>전자금융거래에 관한 기록 : 5년</li>
              </ol>
            </li>
            <li className={styles.term}>
        ...
        <p className={styles.termTitle}>제13조 (개인정보의 파기원칙)</p>
        <p className={styles.termBody}>
        ...
        <div className={styles.termBody}>
          <ol type="1" className={styles.termLists}>
            ...
            <li className={styles.term}>
              회사는 장기 미이용 이용자의 개인정보는 별도로 분리되어 안전하게
            ...
            <li className={styles.term}>
              장기 미이용 이용자는 웹사이트에 로그인할 경우 이용자의 동의에 따라
              본인의 계정을 복원할 수 있습니다.
            </li>
            <li className={styles.term}>
              회사는 분리 보관된 개인정보를 3년간 보관 후 지체없이 파기합니다.
            </li>
          </ol>
        </div>

        <p className={styles.termTitle}>제15조 (개인정보파기방법)</p>
        <p className={styles.termBody}>
        ...
        <div className={styles.termBody}>
          <ol type="1" className={styles.termLists}>
            ...
            <li className={styles.term}>
              ...
              철회하기 위해서는 담당자에게 서면, 전화 또는 전자우편주소로
              연락하시면 회사는 지체 없이 조치하겠습니다.
            </li>
          </ol>
        </div>

        <p className={styles.termTitle}>제17조 (개인정보 정보변경 등)</p>
        <div className={styles.termBody}>
          <ol type="1" className={styles.termLists}>
            <li className={styles.term}>
            ...
            <li className={styles.term}>
              회사는 전항의 경우에 개인정보의 정정을 완료하기 전까지 개인정보를
        ...
        <p className={styles.termTitle}>제18조 (이용자의 의무)</p>
        <div className={styles.termBody}>
          <ol type="1" className={styles.termLists}>
            <li className={styles.term}>
        ...
        <p className={styles.termTitle}>제19조 (회사의 개인정보 관리)</p>
        <p className={styles.termBody}>
        ...
        <p className={styles.termTitle}>제20조 (삭제된 정보의 처리)</p>
        <p className={styles.termBody}>
        ...
        <p className={styles.termTitle}>제21조 (해킹 등에 대비한 대책)</p>
        <p className={styles.termBody}>
          회사는 해킹, 컴퓨터 바이러스 등 정보통신망 침입에 의해 이용자의
          개인정보가 유출되거나 훼손되는 것을 막기 위해 최선을 다하고 있습니다.
          <br />
          회사는 최신 백신프로그램을 이용하여 이용자들의 개인정보나 자료가 유출
          또는 손상되지 않도록 방지하고 있습니다. <br />
          회사는 민감한 개인정보(를 수집 및 보유하고 있는 경우)를 암호화 통신
        ...
        <div className={styles.termBody}>
          ...
          사실을 안 때에는 지체 없이 다음 각 호의 모든 사항을 해당 이용자에게
          알리고 방송통신위원회 또는 한국인터넷진흥원에 신고합니다.
          <ol type="1" className={styles.termLists}>
            <li className={styles.term}>유출 등이 된 개인정보 항목</li>
            <li className={styles.term}>유출 등이 발생한 시점</li>
            <li className={styles.term}>이용자가 취할 수 있는 조치</li>
            <li className={styles.term}>
            ...
            <li className={styles.term}>
              ...
              <ol type="A" className={styles.termLists}>
                <li className={styles.term}>
                  ...
                  정당한 사유가 있는 경우에는 회사의 홈페이지에 30일 이상
                  게시하는 방법으로 전조의 통지를 갈음하는 조치를 취할 수
                  있습니다.
                </li>
              </ol>
            </li>
